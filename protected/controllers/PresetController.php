...
class PresetController extends Controller
{
	...
	{
		$dataProvider=new CActiveDataProvider('Preset');
	...
	{
		$model=new Preset('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Preset']))
			$model->attributes=$_GET['Preset'];
	...
	{
		$model=Preset::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param Preset $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='preset-form')
		{
